...
#define STRING_CONFIG_H_AUTHOR "(WillianS)" // Original author or contributor.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  16.27
    #define DEFAULT_KI   1.20
    #define DEFAULT_KD 55.31
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 95.88 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, -0.18 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define HOMING_FEEDRATE_MM_M { (50*60*2), (50*60*2), (4*60*2) }
